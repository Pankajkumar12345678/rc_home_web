...
const Gallery = () => {
  ...
  return (
    <div className="relative py-10 bg-gradient-to-b from-white via-pink-50/20 to-white overflow-hidden">
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          >
            <div className="text-center">
              <h3 className="text-lg font-bold text-gray-700 mb-4">Photos by Category</h3>
              <div className="flex flex-wrap justify-center gap-4">
                {categories.slice(1).map((category) => (
                  <div key={category.id} className="flex items-center gap-2 px-4 py-2 bg-gray-50 rounded-lg">
